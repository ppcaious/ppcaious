## 👋 Olá! Eu sou o Caio Almeida de Souza/ ppcaious
...
<svg xmlns="http://www.w3.org/2000/svg" width="467" height="150" viewBox="0 0 467 150" fill="none" role="img" aria-labelledby="descId">
        ...
        <desc id="descId">Total Stars Earned: 76264, Total Commits in 2025 : 69, Total Issues: 180</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 34.80784582590917;
      }
    }
      ...
      @keyframes fadeInAnimation {
        ...
        <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="#e4e2e2" width="466" fill="#ffffff00" stroke-opacity="1"/>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="stars">76.3k</text>
    </g>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">69</text>
    </g>
